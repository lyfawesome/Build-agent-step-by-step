...
# @tool 生成的是一个 StructuredTool 对象。
# LangChain 会根据函数名、docstring 和类型标注生成工具说明与参数 Schema。
print("Tool 名称:")
...
print(json.dumps(get_project_power.args_schema.model_json_schema(), ensure_ascii=False, indent=2))
